...
def enviar_correo(destinatarios, titulo, cuerpo):
    ...
    #axcusxrbxnweylzn
    print(password_email_emisor is None)
    ...
    # Agregamos el cuerpo pero en un html
...
def enviar_correos_adjuntos(destinatarios, titulo):
    cuerpo = 'Por favor revosa los archivos adjuntos'
    mensaje = MIMEMultipart()
    email_emisor =  environ.get('EMAIL_SENDER')
    password_email_emisor = environ.get('PASSWORD_SENDER')
